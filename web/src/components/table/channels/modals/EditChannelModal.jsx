...
const EditChannelModal = (props) => {
    ...
    if (success) {
      ...
      if (data.setting) {
        try {
          ...
          data.system_prompt_replace =
            parsedSettings.system_prompt_replace || false;
        } catch (error) {
          ...
          data.system_prompt_replace = false;
        }
      } else {
        data.force_format = false;
        data.thinking_to_content = false;
      ...
      setChannelSettings({
        ...
        system_prompt_replace: data.system_prompt_replace || false,
      });
  ...
  const submit = async () => {
    ...
    const channelExtraSettings = {
      ...
      system_prompt_replace: localInputs.system_prompt_replace || false,
    };
    ...
    delete localInputs.system_prompt_replace;
            ...
            const advancedSettingsContent = (
              <div className='space-y-4'>
                ...
                <div className='pt-3'>
                  ...
                  <Form.Switch field='system_prompt_replace' label={t('系统提示词替换')} checkedText={t('开')} uncheckedText={t('关')} onChange={(value) => handleChannelSettingsChange('system_prompt_replace', value)} extraText={t('如果用户请求中包含系统提示词，则完全替换为渠道配置的系统提示词（优先级高于拼接）')} />
                </div>
              </div>
            );
